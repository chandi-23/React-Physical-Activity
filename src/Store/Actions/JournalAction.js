...
export const saveHealthDetails = (payload) => {
    return async (dispatch, getState) => { 
        try {
            ...
            // const url = `https://node-final-project-j4jc.onrender.com:9000/eventsData?inputText=${inputText}`
...
export const getActivityMasterData = (uuid) => {
    return async (dispatch, getState) => { 
        try {
            const url = `https://node-final-project-j4jc.onrender.com:9000/remainingMasterData/${uuid}`
            const response = await HTTP.get(url);
...
export const getHealthData = (uuid) => {
    return async (dispatch, getState) => { 
        try {
            const url = `https://node-final-project-j4jc.onrender.com:9000/userhealthData/${uuid}`
            const response = await HTTP.get(url);
...
export const getUserFavoriteActivities = (uuid) => {
    return async (dispatch, getState) => { 
        try {
            const url = `https://node-final-project-j4jc.onrender.com:9000/users/${uuid}/useractivity`
            const response = await HTTP.get(url);
...
export const updateActivity = (uuid, userActivityId, newActivity) => {
    return async (dispatch, getState) => { 
        try {
            const url = `https://node-final-project-j4jc.onrender.com:9000/users/${uuid}/useractivity/${userActivityId}`
...
export const updateHealth =(uuid, userActivityId, newHealth)=>{
    return async (dispatch, getState) => { 
        try {
            const url = `https://node-final-project-j4jc.onrender.com:9000/users/${uuid}/userhealth/${userActivityId}`
