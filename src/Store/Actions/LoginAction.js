...
export const signUpUser = (payload) => {
    ...
    return async(dispatch) => {
        try{
            const url = 'https://node-final-project-j4jc.onrender.com:9000/users';
...
export const handleUserVerification = (payload) => {
    ...
    return async(dispatch) => {
        ...
        try{
            const url = 'https://node-final-project-j4jc.onrender.com:9000/users/verify-security/'+username+'?securityQuestion='+payload.securityQuestion+'&&securityAnswer='+payload.securityAnswer;
...
export const loginUser = (payload) => {
    return async (dispatch) => {
        ...
        try {
            const url = 'https://node-final-project-j4jc.onrender.com:9000/users/login/' + username;
            const response = await HTTP.post(url, payload)
...
export const updateUserDetails = (payload, callingComponent) => {
    return async (dispatch) => {
        ...
        try {
            const url = 'https://node-final-project-j4jc.onrender.com:9000/users/' + username;
